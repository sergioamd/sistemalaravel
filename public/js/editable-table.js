    ...
    return {
        ...
        init: function () {
            ...
            function editRow(oTable, nRow) {
                ...
                jqTds[1].innerHTML = '<input type="text" class="form-control small" disabled value="' + aData[1] + '">';
                jqTds[2].innerHTML = '<input type="text" class="form-control small" disabled value="' + aData[2] + '">';
                jqTds[3].innerHTML = '<input type="text" class="form-control small" disabled value="' + aData[3] + '">';
                jqTds[4].innerHTML = '<input type="text" class="form-control small" value="' + aData[4] + '">';
                jqTds[5].innerHTML = '<input type="date" class="form-control small" value="' + aData[5] + '">';
